# A list of well known public keys
{
  ...
  programs.ssh.knownHosts = {
    github-rsa.extraHostNames     = [ "github.com" ];
    ...
    sourcehut-ed25519.extraHostNames = [ "git.sr.ht" ];
